...
#Branch and Bound using Depth First Search Approach

#Grade 10/10 without memoization
...
#Node = namedtuple("Node", ['current_value', 'current_estimative','remaining_capacity', 'parent','level','item','left_tree','right_tree'])
